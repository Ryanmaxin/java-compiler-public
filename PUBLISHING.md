...
The public overview lives in [`README.md`](README.md). [`index.md`](index.md) includes that file, so GitHub Pages renders the same overview at the site URL. Edit the README for content changes; the three reports and `image.png` are linked from it.
